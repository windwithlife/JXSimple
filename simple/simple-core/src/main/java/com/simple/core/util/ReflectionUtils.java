...
public class ReflectionUtils {
	...
	/**
	 * 鐩存帴璇诲彇瀵硅薄灞炴�� 鏃犺private/protected淇グ绗� 涓嶇粡杩噂etter鍑芥暟.
	 */
	...
	/**
	 * 鐩存帴璁剧疆瀵硅薄灞炴�ф棤瑙唒rivate/protected淇グ绗︿笉缁忚繃setter鍑芥暟.
	 */
	...
	/**
	 * 鐩存帴璋冪敤瀵硅薄鏂规硶, 鏃犺private/protected淇グ
	 */
	 ...
	 * 
	 * 濡傚悜涓婅浆鍨嬪埌Object浠嶆棤娉曟壘鍒板垯杩斿洖null.
	 */
	protected static Field getDeclaredField(final Object object, final String fieldName) {
		Assert.notNull(object, "object涓嶈兘涓虹┖");
	...
	/**
	 * 閫氳繃鍙嶅皠, 鑾峰緱瀹氫箟Class鏃跺０鏄庣殑鐖剁被鐨勬硾鍨嬪弬鏁扮殑绫诲瀷. 濡傛棤娉曟壘锟�? 杩斿洖Object.class.
	 * 
	...
	/**
	 * 鎻愬彇闆嗗悎涓殑瀵硅薄鐨勫睘鎬ч�氳繃getter鍑芥暟), 缁勫悎鎴怢ist.
	 * 
	 * @param collection
	 *            鏉ユ簮闆嗗悎.
	 * @param propertyName
	...
	/**
	 * 鎻愬彇闆嗗悎涓殑瀵硅薄鐨勫睘鎬ч�氳繃getter鍑芥暟), 缁勫悎鎴愮敱鍒嗗壊绗﹀垎闅旂殑瀛楃
	 * 
	 * @param collection
	 *            鏉ユ簮闆嗗悎.
	 * @param propertyName
